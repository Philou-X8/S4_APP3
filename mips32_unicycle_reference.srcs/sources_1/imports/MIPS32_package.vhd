...
package MIPS32_package is
    ...
    constant ALUV_ADDV  : std_logic_vector( 3 downto 0 ) := "0010"; -- added for SIMD -- to be removed
    constant ALUV_ROTV  : std_logic_vector( 3 downto 0 ) := "0100"; -- added for SIMD -- to be removed
    ...
    constant OP_Vtype : std_logic_vector( 5 downto 0 ) := "000001"; -- added for SIMD R type instruction
    ...
    constant OP_SWV   : std_logic_vector( 5 downto 0 ) := "010101"; -- added for SIMD
    constant OP_MOVNV : std_logic_vector( 5 downto 0 ) := "010110"; -- added for SIMD
    ...
    constant OP_STLV  : std_logic_vector( 5 downto 0 ) := "011100"; -- added for SIMD
